...
def predict_career(gender, part_time_job, absence_days, extracurricular_activities,
                   weekly_self_study_hours, math_score, history_score,
                   physics_score, chemistry_score, biology_score,
                   english_score, geography_score, total_score):

    input_data = pd.DataFrame([[gender, part_time_job, absence_days,
    ...
    input_data[['absence_days', 'weekly_self_study_hours', 'math_score',
                ...
                'biology_score', 'english_score', 'geography_score']] = scaler.transform(
        input_data[['absence_days', 'weekly_self_study_hours', 'math_score',
                    'history_score', 'physics_score', 'chemistry_score',
...
st.markdown("Enter your academic and background details to predict your future career path.")
